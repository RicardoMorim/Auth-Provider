...
/**
 * Default JPA implementation for Repositories.
 ...
 * If you want to use the postgreSQL implementation, change the property `ricardo.auth.repositories` to `postgresql`.
 */
@Repository
